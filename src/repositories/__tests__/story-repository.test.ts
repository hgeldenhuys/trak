...
describe('StoryRepository', () => {
  ...
  describe('create', () => {
    ...
    it('should emit story:created event', () => {
      ...
      expect((createdEvent?.payload as { entityId: string }).entityId).toBe(story.id);
    });
  ...
  describe('update', () => {
    ...
    it('should emit story:updated event', () => {
      ...
      expect((updatedEvent?.payload as { changedFields: string[] }).changedFields).toContain('title');
    });
  ...
  describe('updateStatus', () => {
    ...
    it('should emit story:status-changed event', () => {
      ...
      expect((statusEvent?.payload as { previousStatus: string }).previousStatus).toBe(StoryStatus.DRAFT);
      expect((statusEvent?.payload as { newStatus: string }).newStatus).toBe(StoryStatus.IN_PROGRESS);
    });
  ...
  describe('delete', () => {
    ...
    it('should emit story:deleted event', () => {
      ...
      expect((deletedEvent?.payload as { entityId: string }).entityId).toBe(created.id);
    });
