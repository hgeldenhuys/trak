...
describe('FeatureRepository', () => {
  ...
  describe('create', () => {
    ...
    it('should emit feature:created event', () => {
      ...
      expect((capturedEvents[0].payload as any).entityId).toBe(feature.id);
      expect((capturedEvents[0].payload as any).entity).toEqual(feature);
    });
  ...
  describe('update', () => {
    ...
    it('should emit feature:updated event with changed fields', () => {
      ...
      const payload = capturedEvents[0].payload as any;
