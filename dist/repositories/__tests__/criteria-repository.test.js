...
import { AcceptanceCriteriaRepository, acceptanceCriteriaRepository, } from '../criteria-repository';
...
describe('AcceptanceCriteriaRepository', () => {
    ...
    describe('create', () => {
        ...
        it('should emit ac:created event', () => {
            ...
            const createEvents = capturedEvents.slice(startEventCount).filter((e) => e.entityId === ac.id);
    ...
    describe('verify', () => {
        ...
        it('should emit ac:verified event', () => {
            ...
            const verifyEvents = capturedEvents.slice(startEventCount).filter((e) => e.entityId === created.id);
    ...
    describe('delete', () => {
        ...
        it('should emit ac:deleted event', () => {
            ...
            const deleteEvents = capturedEvents.slice(startEventCount).filter((e) => e.entityId === deletedId);
